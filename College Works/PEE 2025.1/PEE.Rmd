...
### 📊 Resumo do modelo GMM

```{r gmm-resumo, message=FALSE, warning=FALSE}

coefs_gmm <- summary(modelo_gmm, robust = TRUE)$coefficients 

as.data.frame(coefs_gmm) %>% rownames_to_column("Variável") %>% rename(
  `Estimativa` = Estimate,
  ...
  subtitle = "Modelo com efeitos individuais e diferenciação em primeiras diferenças"
...
### 📊 Estimando o modelo GMM para as classes de Acemoglu
...
#### 📊 Estimando o modelo GMM para a classe High
...
##### 📊 Resumo do modelo GMM para a classe High

```{r gmm-resumo-high, message=FALSE, warning=FALSE}

coefs_gmm_high <- summary(gmm_high, robust = TRUE)$coefficients

as.data.frame(coefs_gmm_high) %>% rownames_to_column("Variável") %>% rename(
  `Estimativa` = Estimate,
  `Erro Padrão` = `Std. Error`,
  `Estatística z` = `z-value`,
  `p-valor` = `Pr(>|z|)`
...
#### 📊 Estimando o modelo GMM para a classe Medium
...
#### 📊 Estimando o modelo Efeitos Fixoa para a classe Low
...
##### 📊 Resumo do modelo Efeito Fixo para a classe Low
