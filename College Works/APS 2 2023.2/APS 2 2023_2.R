...
#Tratando os dados----
"Houve um preenchimento incorreto das respostas, seja na formulação do formulário ou na passagem das respostas para o Excel. Com a finalidade de obter uma resposta mais acertiva, teremos que corrigir os dados de acordo com os padrão pré-estabelecidos"
